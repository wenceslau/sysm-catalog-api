...
import com.sysm.catalog.infrastructure.Fixture;
import com.sysm.catalog.infrastructure.GraphQLControllerTest;
...
public class CategoryGraphQLControllerTest {
    ...
    public void givenDefaultArgumentsWhenCallsListCategoriesShouldReturn() {
        ...
        verify(this.listCategoryUseCase, times(1)).execute(captor.capture());
    ...
    public void givenCustomArgumentsWhenCallsListCategoriesShouldReturn() {
        ...
        final var expectedCategories = categories;
